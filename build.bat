...
py -3-64 -m nuitka --onefile --standalone --enable-plugin=tk-inter --disable-console --include-data-dir="D:\Documents\VS Code\game_mover\src\icon=icon" -o game_mover.exe GUI.py